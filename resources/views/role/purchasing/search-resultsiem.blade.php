        ...
        <div class="row " style="background-color: #f1f1f6">
            ...
            <div class="col-md">
                <div class="mb-3" style="font-size: 14px">
                    ...
                    <input type="text" class="form-control form-control-sm " name="podate[]" required value="{{$result->arahserat}}"> 
                </div>
            </div>
            <div class="col-md">
                <div class="mb-3" style="font-size: 14px">
    ...
    <div class="row " style="background-color: #f1f1f6">
        ...
        <div class="col-md">
            <div class="mb-3" style="font-size: 14px">
                ...
                <input type="hidden" class="form-control form-control-sm " name="panjang[]" >
                <input type="hidden" class="form-control form-control-sm " name="lebar[]" >
                <input type="hidden" class="form-control form-control-sm " name="tinggi[]" >
            </div>
        </div>
    </div>
    <div class="row " style="background-color: #f1f1f6">
