                                ...
                                <table class="table">
                                            ...
                                            <th class="text-dark"> 
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="/arrivalpokadept" class="dropdown-item ">
                                    ...
                                    @foreach($arrivals as $arrival)
                                        <tr>
                                            ...
                                            <td style="padding-top: 3px; padding-bottom:3px;"><a href='{{route("arrivalpokadept.show",$arrival->po)}}' class='btn btn-info btn-sm'>Detail</a></td>
