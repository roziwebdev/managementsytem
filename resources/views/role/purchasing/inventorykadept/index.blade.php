                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            <h4 class="card-title mb-3">Form Add Item</h4>
                            <form class="form-sample" method="POST" action="{{ route('inventorykadept.store') }}"
                                id="pricelistForm">
                                @csrf
                                        ...
                                        <th style="font-size: 14px; width: 40px" class="py-2 my-2 sticky"> 
                                                <div class="dropdown">
                                                    <a class="absolute text-dark text-decoration-none dropdown-toggle"
                                                        href="/inventorykadept" role="button" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        ID
                                                    </a>
                                        ...
                                        <tr>
                                            <div class="table-responsive">
                                                ...
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                 ...
                                                 <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    <a class="btn btn-sm btn-gradient-info" href="{{ route('inventorykadept.show', $data->id) }}">Detail</a>
                                                </td>
                                            </div>
                                        </tr>
                                    @endforeach
