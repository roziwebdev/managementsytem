                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <input value="{{ $purchaseOrder->product }}" type="text" class="form-control"
                            ...
                            <div class="card-body">
                                ...
                                <input value="{{ $purchaseOrder->supplier }}" type="text" id="search"
                                    placeholder="Supplier" list="supplier" name="supplier" class="form-control">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card-body">
                                        <input value="{{ $purchaseOrder->mrdate }}" type="date" name="mrdate"
                                            class="form-control" />
                                ...
                                <div class="col">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <datalist id="alamat">
                                            <option value="JL Imam Bonjol 838 Singosari, Malang"></option>
                                            <option value="JL Mondoroko 14 Singosari, Malang"></option>
                                        </datalist>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Ref</h5>
                                    </div>
                                    <div class="card-body">
