            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                        ...
                        <div class="collapse" id="general-pages3">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        ...
                                        List Quotation</a></li>
                                <li class="nav-item"> 
                                <a class="nav-link" href="/manager/sales">
                                    List SC
                                    <span class="fw-bold float-end" style="color:#c183ff; padding-left:50px" style="color:#c183ff">
                                            {{$waitingSales}}
                                    </span> 
                                </a>
                                </li>
                                <li class="nav-item"> 
                                    <a class="nav-link" href="/manager/tendermgr">
                                        List Tender
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="general-pages3">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/manager/prodev">
                                        List JOB
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic2s">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/manager/docketold">List Docket Old</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/manager/docketnew">List Docket New</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/manager/material">
                                        MR List
                                    <span class="fw-bold float-end" style="color:#c183ff; padding-left:55px">
                                            {{$waitingListMR}} 
                                    </span> 
                                    </a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/manager/purchase">PO List
                                    <span class="fw-bold float-end" style="color:#c183ff; padding-left:55px">
                                            {{$waitingPO}}
                                    </span> 
                                    </a>
