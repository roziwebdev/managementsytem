...
<footer class="footer">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">
            <a style="text-decoration:none; cursor:auto" class="text-muted d-block text-center text-sm-start d-sm-inline-block" href="/managernonppn/salesnonppn">
                @    
            </a>
            <a style="text-decoration:none; cursor:auto" class="text-muted d-block text-center text-sm-start d-sm-inline-block" href="/managernonppn/prodevnonppn">
                2024    
            </a>
        </span>
