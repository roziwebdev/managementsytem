          ...
          <!--Modal!-->
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('update_status', $user->id) }}"
                                                    ...
                                                    <div class="px-2">
                                                        <div class="pb-3">
                                                            ...
                                                            <input type="radio" value="Approve {{ Auth::user()->name }}" id="newStatus" name="newStatus">
                                                                Approve
                                                            </label>
                                                            @endif
                                                ...
                                                <div class="modal fade" id="editStatusModal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="editStatusModalLabel{{ $user->id }}" aria-hidden="true">
                                                                    ...
                                                                    <form action="{{ route('update_status', $user->id) }}"
                                                                        ...
                                                                        <div class="">
                                                                            ...
                                                                            <label class="btn btn-success ">
                                                                                <input type="radio" value="Approve {{ Auth::user()->name }}"
                            ...
                            <div class="border shadow border-secondary  rounded" style="background:#F0F0F0">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg">
                                            <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Number Job
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</span>
                                                {{ $data->kosong1 }}</p>
                                                ...
                                                <table class="table table1 table-bordered border-secondary">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pt-2 pb-2 col-sm ">{{ $user[3] }}</td>
                                ...
                                <table class="table" id="myTable">
                                    <thead>
                                        <tr class="" style="background-color: #f1f1f6">
                                            <th style="font-size: 14px; width: 30px" class="py-2 my-2 sticky"> 
                                                <div class="dropdown">
                                            ...
                                            <th style="font-size: 14px; width: 30px" class="py-2 my-2"> PO </th>
                                            <th style="font-size: 14px; width: 30px" class="py-2 my-2"> 
                                                <div class="dropdown">
                                                    <a class="absolute text-dark text-decoration-none dropdown-toggle"
                                                        href="#" role="button" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                            ...
                                            <th style="font-size: 14px; width: 30px" class="py-2 my-2 "> Type </th>
                                            <th style="font-size: 14px; width: 30px" class="py-2 my-2"> 
                                                <div class="dropdown">
                                                    <a class="absolute text-dark text-decoration-none dropdown-toggle"
                                                        href="#" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <tbody id="pricelistTableBody">
                                        ...
                                        @foreach ($materialrequests as $user)
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <td data-bs-toggle="modal" data-bs-target="#exampleModalToggleDetail{{ $user->id }}" style="padding-top: 3px; padding-bottom:3px;" class="sticky">
                                                        {{ $user->id }}
                                                    </td>
                                                    ...
                                                    <td data-bs-toggle="modal" data-bs-target="#exampleModalToggleDetail{{ $user->id }}" style="padding-top: 3px; padding-bottom:3px;" class="">
                                                        @if ($user->dept == 'FA & TAX')
                                                            <span class="material-symbols-outlined text-dark align-middle" style='font-size:15px'>
                                                                payments
                                                            </span> {{ $user->created }}
                                                    ...
                                                    <td data-bs-toggle="modal" data-bs-target="#exampleModalToggleDetail{{ $user->id }}" style="padding-top: 3px; padding-bottom:3px;" class="ellipsis">
                                                        {{ $firstItem }}</td>
                                                    <td data-bs-toggle="modal" data-bs-target="#exampleModalToggleDetail{{ $user->id }}" style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    ...
                                                    <td  style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModalToggleDetail{{ $user->id }}">Approve / Detail</button></li>
                                                            </ul>
