            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"href="/lembursatpamkadept">List SPL Satpam</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"href="/lemburkadept">List SPL Non Staff</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"href="/approvespl">SPL Non Staff Export</a>
                                </li>
                                @else
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"href="/splstaffapprove">SPL Staff Export</a>
                                </li>
                                @else
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/jobapprove">List JOB ORDER</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic2" aria-expanded="false"
                            aria-controls="ui-basic2">
                            <span class="menu-title">Packaging System</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-square-inc menu-icon"></i>
                        </a>
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/packagingallkadept">List PS</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/kadeptprodev/kadeptlistjob">List JOB
                                    <span class="fw-bold float-end" style="color:#c183ff; padding-left:50px">
                                            {{$waitingJOB}}
                                    </span>
                                </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="/customerprodevkadept">List Customer</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="/plantprodevkadept">List Plant</a>
                                </li>
                            </ul>
                        </div>
                    </li>    
                    @elseif(auth()->user()->departement == "FA & TAX")
                     <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/financekadept/job">List JOB</a></li>
                            </ul>
                        </div>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic3">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link"href="/satpamkadept">List Satpam</a>
                                    </li>
                                </ul>
                                </div>
                        </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="/purchaseorderkadept">List PO
                                        <span class="fw-bold float-end" style="color:#c183ff; padding-left:63px">
                                            {{$waitingPO}}
                                        </span>
                                        </a>
