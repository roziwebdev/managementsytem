                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('mgrarrival.store') }}" enctype="multipart/form-data" id="pricelistForm">
                                @csrf
                                <div class="row stretch-card grid-margin shadow" style="background-color: #f1f1f6">
                                    ...
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="file" class="form-control form-control-md" name="sjimage">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row  shadow" style="background-color: #f1f1f6">
                                    ...
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="date" class="form-control form-control-sm " name="tanggalbeli" required id='arrivalDate'>
                                        </div>
                                    </div>      
                                    <script>
                                ...
                                <table class="table">
                                   ...
                                   @if($arrival->po == $materialrequest->id)
                                        <tr>
                                            ...
                                            <td><button class='pe-none btn btn-info btn-sm' aria-disabled="true">Open</button></td>
