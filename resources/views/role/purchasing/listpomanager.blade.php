                                            ...
                                            >
                                                ...
                                                <td style="font-size: 14px; padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModalToggleDetail{{ $user->id }}">Approve</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item" href="{{route('purchase.show', $user->id) }}" >Detail</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
