...
<footer class="footer">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">
            <a style="text-decoration:none; cursor:auto" class="text-muted d-block text-center text-sm-start d-sm-inline-block" href="/salesnonppndept">
                @    
            </a>    
            <a style="text-decoration:none; cursor:auto" class="text-muted d-block text-center text-sm-start d-sm-inline-block" href="/jobdeptapprovenonppn">
                2024    
            </a>    
        </span>
        @elseif(auth()->user()->departement != "sales")
        <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">
            <a style="text-decoration:none; cursor:auto" class="text-muted d-block text-center text-sm-start d-sm-inline-block" href="/jobdeptapprovenonppn">
                @
            </a>    
            <a style="text-decoration:none; cursor:auto" class="text-muted d-block d-sm-inline-block" href="#">
                2024    
            </a>    
        </span>
        @endif
