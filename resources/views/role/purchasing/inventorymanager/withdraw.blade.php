                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('withdrawmgr.store') }}"
                                id="pricelistForm">
                                @csrf
            ...
            <div class="">
                <div class="card rounded-xl shadow">
                    <div class="card-body shadow border">
                        <h3 class="text-center pb-3">LIST WITHDRAWAL</h3>
                                                ...
                                                <td style="padding-top: 3px; padding-bottom:3px;">
                                                    @if ($data->status === 'waiting')
                                                        <a class="btn btn-sm btn-gradient-warning"
                                                            href="{{ route('withdrawmgr.updateStatus', ['id' => $data->id]) }}">Waiting</a>
