            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('kadeptsplstaff.store') }}" id="pricelistForm">
                            @csrf
                            ...
                            <table class="table" id="myTable">
                                <thead>
                                    <tr style="background-color: #f1f1f6">
                                                            ...
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="">
                                                                    <button type="submit"class="dropdown-item ">All Dept</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="Logistik">
                                                                    <button type="submit"class="dropdown-item ">Logistik</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="HRGA">
                                                                    <button type="submit"class="dropdown-item ">HRGA</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="FA & TAX">
                                                                    <button type="submit"class="dropdown-item ">FA & TAX</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="PPIC RM">
                                                                    <button type="submit"class="dropdown-item ">PPIC RM</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="PPIC SM">
                                                                    <button type="submit"class="dropdown-item ">PPIC SM</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="Produksi">
                                                                    <button type="submit"class="dropdown-item ">Produksi</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="QA">
                                                                    <button type="submit"class="dropdown-item ">QA</button>
                                                                </form>
                                                            </li>
                                                            <li>
                                                                 <form action="" method="GET"
                                                                    ...
                                                                    <input type="hidden" name="departement"
                                                                        value="QC">
                                                                    <button type="submit"class="dropdown-item ">QC</button>
                                                                </form>
                                                            </li>
                                        ...
                                        <th class="" style="font-size: 14px; width:;" scope="col">KET KERJA</th>
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        @foreach ($combinedData as $data )
                                            @if (auth()->user()->departement == "HRGA" && $lembur->status == "Waiting List" || $lembur->status == "Approve" && $lembur->status == 'Waiting' && $data[2] == auth()->user()->departement)
                                            <tr>
                                                ...
                                                <td style="padding-top: 5px; padding-bottom:5px;" class="d-flex ">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item" href="{{ route('kadeptsplstaff.edit', $lembur->id) }}">Edit</a></li>
                                                            @endif
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ route('updateStatusstaffkadept', $lembur->id) }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="">
