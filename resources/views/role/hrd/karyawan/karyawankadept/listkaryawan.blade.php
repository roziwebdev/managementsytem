                ...
                <div class="col-12 stretch-card grid-margin" id="myForm">
                    <div class="border rounded card">
                        <div class="border rounded shadow card-body">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('karyawannonstaff.store') }}"
                                id="pricelistForm">
                                @csrf
                                        ...
                                        <div class="mt-3 col-md">
                                            <div class="mb-3" style="font-size: 14px">
                                                ...
                                                <input type="date" class="form-control form-control-sm clickable"
                                                    name="tglmasuk" placeholder="" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table" id="materialRequestTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 5px; padding-bottom: 5px">{{ $karyawan->departement }}
                                            </td>
                                            ...
                                            <td style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('karyawannonstaff.edit', $karyawan->id) }}">Edit</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
