            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('lembur.update', $lembur->id) }}" id="pricelistForm">
                            @method("PUT")
                            @csrf
                            @php
                            ...
                            <div data-index='{{$index}}'>
                                ...
                                <div class="py-4">
                                    <button class="btn btn-gradient-danger btn-sm" type="button" onclick="confirmRemove({{$index}})">Remove</button>
                                </div>
                            </div>
                            @endforeach
                            <div>
