                                            ...
                                            <table class="table table1 table-bordered border-secondary">
                                                ...
                                                <tbody>
                                                    ...
                                                    <form action="{{ route('updateLayoutKadept', $data->id) }}"  method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method("PUT")
                                                        @if($data->a != null && $data->filea == null)
                                                        <tr>
                                                        ...
                                                        @elseif($data->a != null && $data->filea != null && $data->statusa == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->a}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filea) }}')" class="badge badge-warning"  style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->a != null && $data->filea != null && $data->statusa == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->a}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filea) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->b != null && $data->fileb == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->b != null && $data->fileb != null && $data->statusb == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->b}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->fileb) }}')" class="badge badge-warning"  style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->b != null && $data->fileb != null && $data->statusb == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->b}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->fileb) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        @if($data->c != null && $data->filec == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->c != null && $data->filec != null && $data->statusc == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->c}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filec) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                         @elseif($data->c != null && $data->filec != null && $data->statusc == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->c}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filec) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->d != null && $data->filed == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->d != null && $data->filed != null && $data->statusd == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->d}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filed) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                         @elseif($data->d != null && $data->filed != null && $data->statusd == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->d}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filed) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->e != null && $data->filee == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->e != null && $data->filee != null && $data->statuse == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->e}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filee) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->e != null && $data->filee != null && $data->statuse == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->e}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filee) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->f != null && $data->filef == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->f != null && $data->filef != null && $data->statusf == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->f}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filef) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->f != null && $data->filef != null && $data->statusf == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->f}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filef) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->g != null && $data->fileg == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->g != null && $data->fileg != null && $data->statusg == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->g}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->fileg) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->g != null && $data->fileg != null && $data->statusg == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->g}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->fileg) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->h != null && $data->fileh == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->h != null && $data->fileh != null && $data->statush == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->h}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->fileh) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->h != null && $data->fileh != null && $data->statush == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->h}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->fileh) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @if($data->i != null && $data->filei == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->i != null && $data->filei != null && $data->statusi == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->i}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filei) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        @elseif($data->i != null && $data->filea != null && $data->statusi == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->i}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filei) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        @if($data->j != null && $data->filej == null)
                                                        <tr>
                                                            <td class="pt-2 pb-2" colspan="2">
                                                        ...
                                                        @elseif($data->j != null && $data->filej != null && $data->statusj == "Send")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->j}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filej) }}')" class="badge badge-warning" href="" style="text-decoration:none;">
                                                                    Send
                                                                </a>
                                                            </td>
                                                        @elseif($data->j != null && $data->filej != null && $data->statusj == "Approve")
                                                        <tr>
                                                            <td class="pt-2 pb-2 col-sm-4">
                                                                Layout {{$data->j}}
                                                            </td>
                                                            <td class="pt-2 pb-2 col-sm-8">
                                                                <a href="javascript:void(0)" onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filej) }}')" class="badge badge-success"  style="text-decoration:none;">
                                                                    Uploaded
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <td style="padding-top: 5px; padding-bottom:5px;" class="d-flex ">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    @endif
                                                        <li>
                                                            <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#exampleModalToggle{{ $designrequest->id }}">
                                                                Detail
                                                            </a>
                                                        </li>
                                                </ul>
