    ...
    <div class="mt-2 border" style="margin-right:px; margin-left:px;">
        ...
        <div class="">
            <div  class="table-responsive">
                <table style="margin:0;" class="table table-borderless">
                    <tbody>
                        <tr class="border-bottom">
                            <td style="margin::0; width: 260px; padding-top:0; padding-bottom:0; ;" class="pt-2 align-items-center text-center border-end text-wrap">
                                {{ $job->notesc }},<br/>
                                {{ $job->noteedit }}
                            </td>
                ...
                <p class="px-2" style="margin: 0; font-size:17px ">{{ $job->note2 }}</p>
