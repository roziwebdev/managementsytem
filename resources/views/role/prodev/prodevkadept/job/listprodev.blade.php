            ...
            <div class="">
                <div class="shadow card rounded-xl">
                    <div class="border shadow card-body">
                        <h3 class="pb-3 text-center">SC</h3>
                            ...
                            <table class="table" id="materialRequestTable">
                                <thead>
                                    <tr style="background-color: #f1f1f6">
                                        ...
                                        <th style="font-size: 14px;" scope="col" class="">REVISI</th>
                                ...
                                $combinedData = array_filter(array_map(null, $products, $jobsc,$statusproducts,$saps), function ($item) {
                                return $item[1] === null;
                                });
                                @endphp
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:2px; padding-bottom:2px;">{{ $all[3] }}</td>
                                    ...
                                    <td style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('kadeptjob.createshowsc', ['id' => $data->id, 'index' => $index]) }}">Create JOB ORDER</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('kadeptjobtrial.createshowsc', ['id' => $data->id, 'index' => $index]) }}">Create JOB TIAL</a></li>
