                ...
                <table style="margin:0;" class="table table-borderless">
                    <tbody>
                        <tr class="border-bottom">
                            <td style="margin::0; width: 260px; padding-top:0; padding-bottom:0; ;" class="pt-4 align-items-center text-center border-end text-wrap">{{ $job->notesc }}</td>
                            <td style="padding-top: 0; padding-bottom:0; font-size:25px;" class="py-2 text-center ">
                               JOB NUMBER : <span class="px-2 border ">T{{ $job->id }}</span>    
                                <br/>
