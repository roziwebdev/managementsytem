                            ...
                            <table class="table" id="materialRequestTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->boxname }}</td>
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->specs }}</td>
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->size }}</td>
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->toleransi }}</td>
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->note1 }}</td>
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->note2}}</td>
                                        <td style="font-size: 14px; width:; padding-top:2px; padding-bottom:2px;">{{ $box->note3}}</td>
                                        <td style="font-size: 14px; padding-top:2px; padding-bottom:2px;">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="{{ route('kadeptboxes.edit', $box->id) }}">Edit</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
