        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kadeptupdateFileDesign', $design->id) }}" method="POST"
    ...
    <div class="modal fade" id="editStatusLayoutModal{{ $design->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kadeptupdateStatusLayout', $design->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="">
                            <label class="btn btn-success ">
            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{route('kadeptdesignnumber.store')}}">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 14px; padding-top:4px; padding-bottom:4px;">
                                            ...
                                            @endif
                                        <td style="font-size: 14px; padding-top:4px; padding-bottom:4px;">{{ \Carbon\Carbon::parse($data->created_at)->format('j M y') }}</td>
                                        <td style="font-size: 14px; padding-top:4px; padding-bottom:4px;">
                                           <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('kadeptdesignnumber.edit', $design->id) }}">Edit</a></li>
                                            </ul>
                                        </div>
                                        </td>
