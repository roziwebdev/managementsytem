            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('packaging.store') }}" id="pricelistForm" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <td style="font-size: 14px; padding-top:2px; padding-bottom:2px;" class="d-flex">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('packaging.edit', $packaging->id) }}">Edit</a>
                                                    </li>
