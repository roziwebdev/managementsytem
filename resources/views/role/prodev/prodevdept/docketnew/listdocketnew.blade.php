                                        ...
                                        <div class="border shadow-sm table-responsive table-responsive1"
                                            ...
                                            <table class="table table1 table-bordered border-secondary">
                                                ...
                                                <tbody>
                                                    ...
                                                    @if($data->a == "A" && $data->filea != null && $data->statusa == "Send" )
                                                    <tr>
                                                    ...
                                                    @elseif($data->a == "A" && $data->filea != null  && $data->statusa == "Approve" )
                                                    <tr>
                                                        <td class="pt-2 pb-2 col-sm-4">
                                                            Layout {{$data->a}}
                                                        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('updateFileDesignDocketnew', $design->id) }}" method="POST"
    ...
    <div class="modal fade" id="editStatusLayoutModal{{ $design->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('updateStatusLayoutDocketnew', $design->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="">
                            <label class="btn btn-success ">
            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{route('docketnew.store')}}">
                            @csrf
                                        ...
                                        <td style="font-size: 14px; padding-top:4px; padding-bottom:4px;">
                                           <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('docketnew.edit', $design->id) }}">Edit</a></li>
                                            </ul>
                                        </div>
                                        </td>
