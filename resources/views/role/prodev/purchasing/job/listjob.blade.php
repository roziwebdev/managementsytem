                ...
                <div class="modal-header pt-1 pb-0 mb-0">
                    <div class="text-center container-xl pb-0 mb-0">
                        <h1 class="text-center modal-title" style="font-size: 25px"
                            id="exampleModalToggleLabel{{ $data->id }}">JOB ORDER</h1>
                    </div>
                ...
                <div class="modal-body pb-4">
                    <div class="container-xl">
                        <div class="border shadow border-secondary" style="background:#F0F0F0">
                            <div class="">
                                <p style="font-size:18px" class="fw-bold py-2 mb-1">Sales Contract - {{ $data->nosc }}
                                </p>
                            </div>
                            <div class="px-2">
                                <div class="row">
                                    <div class="col-sm">
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Purchase
                                                Order &nbsp;&nbsp;&nbsp;:</span>
                                            <a style="text-decoration:none;"
                                                href="{{ asset('storage/path/to/your/image/' . $data->fileponoprice) }}"
                                                target="_blank">
                                                {{ $data->po }}
                                            </a>
                                        </p>
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Customer
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                : </span>{{ $data->customer }}</p>
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Plant
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</span>
                                            {{ $data->plantcode }}</p>
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Due Date
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</span>
                                            {{ \Carbon\Carbon::parse($data->etauser)->format('j M y')}}</p>
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Quantity
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</span>
                                            {{ $data->qty }} {{ $data->unit }}</p>
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Ukuran
                                                Packaging &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</span> {{
                                            $data->size }}</p>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table1 table-bordered border-secondary">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pt-2 pb-2 col-sm-8">{{
                                                            \Carbon\Carbon::parse($data->tanggalterima)->format('j M
                                                            y')}}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pt-2 pb-2 col-sm-8">
                                                            <a href="javascript:void(0)"
                                                                onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->filelayout) }}')"
                    ...
                    <div class="border shadow card-body">
                        ...
                        <script>
                            function exportTableToXLSX(filename) {
                                var wb = XLSX.utils.table_to_book(document.getElementById('myTablee'), {sheet: "Sheet1"});
                            ...
                            <table class="table" id="materialRequestTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top:2px; padding-bottom:2px;">{{
                                            \Carbon\Carbon::parse($data->etauser)->format('j M y')}}</td>
                                        <td style="padding-top:2px; padding-bottom:2px;">{{
                                            \Carbon\Carbon::parse($data->created_at)->format('j M y')}}</td>
                                        <td style="padding-top:2px; padding-bottom:2px;">{{
                                            \Carbon\Carbon::parse($data->updated_at)->format('j M y')}}</td>
                                        <style>
                                            .container {
                                                display: flex;
                                                align-items: center;
                                        ...
                                        <td style="padding-top:2px; padding-bottom:2px;" class="">
                                            <div class="container">
                                                ...
                                                <span class="readMoreButton" style="display: none; cursor:pointer;"><a
                                                        class="text-primary" onclick="toggleReadMore(this)">Lihat
                                                        Selengkapnya</a></span>
                                            </div>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="" data-bs-toggle="modal"
                                                            data-bs-target="#exampleModalToggle{{ $data->id }}">Detail</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('kadeptjob.print', $data->id) }}">Print</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
