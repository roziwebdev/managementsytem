                                        ...
                                        <div class="border shadow-sm table-responsive table-responsive1"
                                            ...
                                            <table class="table table1 table-bordered border-secondary">
                                                ...
                                                <tbody>
                                                    ...
                                                    @if($dataVar !=null && $data->$fileVar != null && $data->$statusVar
                                                    == "Send")
                                                    <tr>
                                                        ...
                                                        <td class="pt-2 pb-2 col-sm-8">
                                                            <div class="dropdown">
                                                                <a class="badge badge-warning dropdown-toggle" href="#"
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            ...
                                                                            onclick="openImageInNewWindow('{{ asset('storage/path/to/your/image/' . $data->$fileVar) }}')"
                                                                    ...
                                                                    <li>
                                                                        <button class="dropdown-item"
                                                                            ...
                                                                            data-bs-target="#editStatusLayoutModal{{ $char . $data->id }}">
                                                                            Approve
                                                                        </button>
                                                                    </li>
                                                                </ul>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="font-size: 14px; width:20px; padding-top:2px; padding-bottom:2px;"
                                            scope="col" class="sticky">{{ $design->id }}</td>
                                        ...
                                        <!--</td>-->
                                        <td style="font-size: 14px; padding-top:4px; padding-bottom:4px;">{{
                                            \Carbon\Carbon::parse($design->created_at)->format('j M y') }}</td>
                                        <td style="font-size: 14px; padding-top:4px; padding-bottom:4px;">
                                            <div class="dropdown">
