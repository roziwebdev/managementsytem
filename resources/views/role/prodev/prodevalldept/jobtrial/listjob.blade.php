                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg">
                                            ...
                                            <p  style="font-size:14px" class="mb-1"><span style="font-weight: 600">Ukuran Packaging &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</span> {{ $data->size }}</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="">
                <div class="shadow card rounded-xl">
                    <div class="border shadow card-body">
                        ...
                        <div class="float-end   ">
                            <button class="btn btn-sm btn-warning align-items-center d-flex  text-dark" onclick="exportTableToXLSX('table.xlsx')">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="font-size: 14px; width:20px; padding-top:2px; padding-bottom:2px;"
                                            scope="col" class="sticky">T{{ $data->id}}</td>
                                        <td style="padding-top:2px; padding-bottom:2px;">TRIAL {{ $data->nosc}}</td>
