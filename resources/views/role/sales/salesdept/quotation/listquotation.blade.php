                        ...
                        <form class="form-sample" method="POST" action="{{ route('quotation.store') }}"
                            ...
                            <div id='row2'>
                                ...
                                <div class="shadow  row" style="background-color: #f1f1f6">
                                    <div class="mt-3 col-md ">
                                        <div class="mb-3" style="font-size: 14px">
                                            <label for="" class="form-label fw-bold">Quantity Nego 1</label>
                                            <textarea class="form-control clickable rounded-3 shadow-sm" name="qty[]" required></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-3 col-md ">
                                        <div class="mb-3" style="font-size: 14px">
                                            <label for="" class="form-label fw-bold">Price Nego 1</label>
                                ...
                                <div class="shadow  row" style="background-color: #f1f1f6">
                                    <div class="mt-3 col-md ">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <textarea class="form-control clickable rounded-3 shadow-sm" name="qty2[]" required></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-3 col-md ">
                                        <div class="mb-3" style="font-size: 14px">
                                            <label for="" class="form-label fw-bold">Price Nego 2</label>
                                            <textarea class="form-control clickable rounded-3 shadow-sm" name="price2[]" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="shadow  row" style="background-color: #f1f1f6">
                                    <div class="mt-3 col-md ">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <textarea class="form-control clickable rounded-3 shadow-sm" name="qty3[]" required></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-3 col-md ">
                                        <div class="mb-3" style="font-size: 14px">
                                            <label for="" class="form-label fw-bold">Price Nego 3</label>
                                            <textarea class="form-control clickable rounded-3 shadow-sm" name="price3[]" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="shadow  row" style="background-color: #f1f1f6">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('quotationsc', $data->id) }}">Create SC</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
