        ...
        <div class="">
            <div class="shadow card rounded-xl">
                <div class="border shadow card-body">
                    ...
                    @endphp
                    <h3 class="pb-3 text-center">TENDER  {{$referensi}}</h3>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table" id="materialRequestTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width:20px;" scope="col" class="sticky">{{ ($tenders->currentPage() - 1) * $tenders->perPage()
                                    + $index + 1 }}</td>
                                    ...
                                    <td style="padding-top:4px; padding-bottom:4px;">
                                        <div class="d-flex">
                                            <a class="px-1" href="{{ route('tender.edit', $tender->id) }}">
                                                <span class=" text-dark material-symbols-outlined">
                                                    edit_square
                                                </span>
                                            </a>
                                            <a class="px-1" href="{{ route('tender.show', $tender->id) }}">
                                                <span class=" text-dark material-symbols-outlined">
                                                    history
                                                </span>
                                            </a>
