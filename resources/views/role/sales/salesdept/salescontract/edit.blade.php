                ...
                <div class="border rounded card">
                    ...
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('salesdept.update', $salescontract->id) }}" enctype="multipart/form-data"
                                ...
                                <div class="row " style="background-color: #f1f1f6">
                                    <div class="mt-3 col-md">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm clickable" name="statussc" value="Revised" required>
                                        </div>
                                    </div>
                                    <div class="mt-3 col-md">
                                        <div class="mb-3" style="font-size: 14px">
                            ...
                            $genscs = json_decode($salescontract->gensc);
                            $combinedData =
                            array_map(null,$products,$saps,$materials,$sizes,$finishings,$specs,$qtys,$units,$prices,$totals,$etausers,$toleransis,$notessc,$statusproduct,$referensis,$genscs);
                            @endphp
                            ...
                            @foreach ($combinedData as $data )
                                <div id='row2'>
                                    <div class="shadow row" style="background-color: #f1f1f6">
                                        <div class="mt-3 col-md ">
                                            <div class="mb-3" style="font-size: 14px">
                                                ...
                                                <input value="{{ $data[15] }}" type="text" class="form-control form-control-sm clickable"
                                                    name="gensc[]" required>
                                            </div>
                                        </div>
                                        <div class="mt-3 col-md ">
                                    ...
                                    <div class="shadow row stretch-card grid-margin" style="background-color: #f1f1f6">
                                        ...
                                        @if($salescontract->statussc == 'Approve')
                                        ...
                                        @elseif($salescontract->statussc == 'Waiting')
                                        <div class="mt-3 col-md">
                                            <div class="mb-3" style="font-size: 14px">
                                                <label for="" class="form-label fw-bold ">Status SC</label>
                                                <select name="statusproduct[]" required class="form-select ">
