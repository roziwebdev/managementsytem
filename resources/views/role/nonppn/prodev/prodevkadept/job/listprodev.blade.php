            ...
            <div class="">
                <div class="shadow card rounded-xl">
                    <div class="border shadow card-body">
                        <h3 class="pb-3 text-center">SC NON PPN</h3>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table" id="materialRequestTable">
                                ...
                                <tr>
                                    <td style="font-size: 14px; width:20px; padding-top:2px; padding-bottom:2px;" scope="col" class="">N{{$data->id }}</td>
                                    ...
                                    <td style="padding-top:2px; padding-bottom:2px;">
                                        <a href="{{ route('kadeptjobnonppn.createshowsc', ['id' => $data->id, 'index' => $index]) }}"
