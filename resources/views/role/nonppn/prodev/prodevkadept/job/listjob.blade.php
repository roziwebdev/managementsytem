                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Form untuk mengedit status -->
                           <form action="{{ route('updateStatusJobnonppn', $user->id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @else
                           <form action="{{ route('reqEditJobnonppn', $user->id) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="">
            ...
            <div class="">
                <div class="shadow card rounded-xl">
                    <div class="border shadow card-body">
                        <h3 class="pb-3 text-center">JOB ORDER NON PPN</h3>
                        <div class="float-end   ">
                            <a href="{{route('downloadTableKadept')}}" class="btn btn-sm btn-warning align-items-center d-flex  text-dark">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="font-size: 14px; width:20px; padding-top:2px; padding-bottom:2px;"
                                            scope="col" class="sticky">N{{ $data->id}}</td>
                                        <td style="padding-top:2px; padding-bottom:2px;">N{{ $data->nosc}}</td>
                                        ...
                                        <td style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('kadeptjobnonppn.print', $data->id) }}">Print</a></li>
                                                    <li>
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('kadeptjobnonppn.edit', $data->id) }}">Edit</a></li>
                                                    <li>
                                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editStatusModal{{ $data->id }}" >Approve</button>
                                                    </li>
