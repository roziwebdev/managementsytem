...
<body>
    ...
    <div class="mt-2 border" style="margin-right:px; margin-left:px;">
        ...
        <div class="">
            <div  class="table-responsive">
                <table style="margin:0;" class="table table-borderless">
                    <tbody>
                        <tr class="border-bottom">
                            ...
                            <td style="padding-top: 0; padding-bottom:0; font-size:25px;" class="py-2 text-center ">
                               JOB NUMBER : <span class="px-2 border ">N{{ $job->id }}</span>    
                                <br/>
                        ...
                        <tr class="border">
                            ...
                            <td class="" style="padding-top: 1px; padding-bottom:1px;">N{{ $job->nosc }}</td>
                        ...
                        <tr class="border">
                            ...
                            <td class="" style="padding-top: 1px; padding-bottom:1px;">{{ \Carbon\Carbon::parse($job->createdsc)->format('j M y') }}</td>
                        </tr>
                        <tr class="border">
                            <td style="padding-top: 1px; padding-bottom:1px; width: 260px" class="border-end ">Due Date :</td>
                           <td class="" style="padding-top: 1px; padding-bottom:1px;">{{ \Carbon\Carbon::parse($job->etauser)->format('j M y') }}</td>
                        </tr>
                        <tr class="border">
                        ...
                        <tr style="margin:0;" class="border">
                            ...
                            <td style="padding-top: 1px; padding-bottom:1px;">N{{ $job->id }} / {{ $job->designno }} / N{{ $job->nosc }} / AMS</td>
                        </tr>
                ...
                <table style="margin: 0;" class="table table-borderless">
                    <tbody style="margin: 0">
                        ...
                        <tr class="border">
                            ...
                            <td class="tw" style="padding-top: 1px; padding-bottom:1px;">{{ $job->specs }}</td>
                        ...
                        <tr class="border">
                            ...
                            <td class="tw" style="padding-top: 1px; padding-bottom:1px;">{{ number_format($job->qty,0) }}</td>
                ...
                <table style="margin: 0" class="table table-borderless">
                    <tbody>
                        ...
                        <tr class="border">
                            ...
                            <td class="tw" style="padding-top: 1px; padding-bottom:1px;">{{ $job->mat1 }}</td>
                            <td style="padding-top: 1px; padding-bottom:1px;">{{ $job->as1 }}</td>
                        </tr>
                        <tr class="border">
                            <td style="padding-top: 1px; padding-bottom:1px; width: 260px"  class="border-end">Arah serat material 2 :</td>
                            <td class="tw" style="padding-top: 1px; padding-bottom:1px;">{{ $job->mat2 }}</td>
                            <td style="padding-top: 1px; padding-bottom:1px;">{{ $job->as2 }}</td>
                            </tr>
                        </tr>
                        <tr class="border">
                            <td style="padding-top: 1px; padding-bottom:1px; width: 260px"  class="border-end">Arah serat material 3 :</td>
                            <td class="tw" style="padding-top: 1px; padding-bottom:1px;">{{ $job->mat3 }}</td>
                            <td style="padding-top: 1px; padding-bottom:1px;">{{ $job->as3 }}</td>
                            </tr>
                        </tr>
                        <tr class="border">
                ...
                <p class="px-2" style="margin: 0; font-size:17px "> Others : {{ $job->note1 }}</p>
