...
<div class="main-panel">
                ...
                <div class="modal-body pb-2">
                    ...
                    <div class="">
                        <div class="border shadow border-secondary rounded" style="background:#F0F0F0">
                            <div class="">
                                <div class="">
                                    <p style="font-size:18px" class="fw-bold py-2 mb-1">Sales Contract - N{{ $data->id }}
                                    </p>
                                </div>
                                <div class="row">
                                    <div class="col-lg">
                                    ...
                                    <div class="col-lg">
                                        <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">Plant&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</span>
                                            {{ $data->plantcode }}</p>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container-xl border" style="height:450px">
        <div class="py-4">
            <div class="border shadow-sm " style="height:400px; overflow:auto" >
                <table class="table table1 table-bordered border-secondary">
                    <thead class="">
                        <tr style="background:#F0F0F0; top:10px" class="">
                            <th class="pt-2 pb-2 col-sm-4 fw-bold">Information</th>
                    ...
                    <tbody>
                        ...
                        <tr style="" class="table-secondary">
                            <td class="pt-2 pb-2 fst-italic" style="font-weight: 600" colspan="2">Product {{ $index +1 }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Product</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[0] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">SAP</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[1] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Material</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[2] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Size</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[3] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Finishing</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[4] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Specs</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[5] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Quantity</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ '' . number_format(floatval(str_replace(',', '.', $datas[6])), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Unit</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[7] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Price</td>
                            <td class="pt-2 pb-2 col-sm-8">Rp. {{ '' . number_format(floatval(str_replace(',', '.', $datas[8])), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Total Price</td>
                            <td class="pt-2 pb-2 col-sm-8">Rp. {{ '' . number_format(floatval(str_replace(',', '.', $datas[9])), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Eta User</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ \Carbon\Carbon::parse($datas[10])->format('j M y') }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Toleransi</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[11] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Note</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[12] }}</td>
                        </tr>
                        <tr>
                            <td class="pt-2 pb-2 col-sm-4">Status</td>
                            <td class="pt-2 pb-2 col-sm-8">{{ $datas[13] }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                        ...
                        <div class="py-3">
                            ...
                            <p>SC sudah Approve/Declined sebelumnya.</p>
                            @else
                            <form action="{{ route('update_statusscnonppn', $data->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="d-flex">
