                ...
                <div class="modal-header pt-1 pb-0 mb-0">
                    <div class="text-center container-xl pb-0 mb-0">
                        <h1 class="text-center modal-title" style="font-size: 25px"
                            id="exampleModalToggleLabel{{ $data->id }}">SALES CONTRACT NON PPN</h1>
                    </div>
            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                ...
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('salesnonppndept.store') }}" enctype="multipart/form-data" id="imageForm">
                            @csrf
                            <div class="shadow">
            ...
            <div class="">
                <div class="shadow card rounded-xl">
                    <div class="border shadow card-body">
                        <h3 class="pb-3 text-center">SALES CONTRACT NON PPN</h3>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    <tr class="bg-hover">
                                        <td data-href="{{ route('salesnonppndept.print', $data->id) }}" style="font-size: 14px; width:20px; padding-top:2px; padding-bottom:2px;" scope="col" 
                                        ...
                                        <td data-href="{{ route('salesnonppndept.print', $data->id) }}" style="padding-top:2px; padding-bottom:2px;"
                                        ...
                                        <td style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('salesnonppndept.edit', $data->id) }}">Edit</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('salesnonppndept.print', $data->id) }}">Print</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
