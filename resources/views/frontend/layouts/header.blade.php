...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::asset('frontend/img/photos/iconlogo.png') }}" />
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/form">
                            <i class="align-middle" data-feather="check-square"></i> <span class="align-middle">Offering
                                Letter</span>
                        </a>
                    </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                ...
                                <img src="{{ URL::asset('frontend/img/photos/logo.png') }}"
                                    ...
                                    class="text-green-900">{{ Auth::user()->name }}
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!--        class="align-middle me-1" data-feather="settings"></i> Settings Account</a>-->
