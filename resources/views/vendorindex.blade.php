        ...
        <div class="container">
            <div class="congratulation-wrapper">
                <div class="congratulation-contents center-text">
                    ...
                    <p class="congratulation-contents-para"> Anda berhasil menjadi supplier dari perusahaan kami PT
                        Arjaya Mukti Santosa.
                    </p>
                    <div class="btn-wrapper mt-4">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf

                            <a class="cmn-btn btn-bg-1" href="route('logout')"
