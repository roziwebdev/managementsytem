                            ...
                            <table class="table" id="myTable">
                                <thead>
                                    <tr style="background-color: #f1f1f6">
                                        <th style="font-size: 14px; width:20px;" scope="col" class="sticky text-center">
                                            <div class="dropdown">
                                            ...
                                            <td style="padding-top: 5px; padding-bottom:5px;" class="d-flex ">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <form id="deleteForm{{ $lembur->id }}" action="{{ route('kadeptsplstaff.destroy', $lembur->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
