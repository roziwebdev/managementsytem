                            ...
                            <table class="table" id="myTable">
                                <thead>
                                    <tr style="background-color: #f1f1f6">
                                        <th style="font-size: 14px; width:20px;" scope="col" class="text-center">
                                            <div class="dropdown">
                                        ...
                                        <th class="text-center" style="font-size: 14px; width:;" scope="col">NAMA</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 5px; padding-bottom:5px;" class="d-flex ">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    @if ($lembur->status == "Waiting" || $lembur->status == "Revisi")
