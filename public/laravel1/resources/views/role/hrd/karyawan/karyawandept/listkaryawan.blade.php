            ...
            <div class="col-12 stretch-card grid-margin" id="myForm">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('karyawan.store') }}" id="pricelistForm">
                            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('karyawan.edit', $karyawan->id) }}">Edit</a></li>
                                                    </ul>
                                                </div>
                                        </td>
                                    </tr>
