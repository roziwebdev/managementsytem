                        ...
                        <form action="" method="GET">
                            <div class="form-row d-sm-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex px-2 gap-2">
                                    ...
                                    <button class="btn btn-dark btn-sm" onclick="exportTableToCSV('myTable', 'spl_nonstaff.csv')">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 5px; padding-bottom:5px;" class="d-flex ">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    @if ($lembur->status == "Waiting" || $lembur->status == "Revisi" || $lembur->status == "Waiting List"   && $lembur->pemberiperintah == Auth::user()->name)
                                                    <li><a class="dropdown-item" href="{{ route('lembur.edit', $lembur->id) }}">Edit</a></li>
                                                    @elseif($lembur->status == "Waiting" || $lembur->status == "Waiting List" )
                                                   
                                                    <li>
                                                        <form id="deleteForm{{ $lembur->id }}" action="{{ route('lembur.destroy', $lembur->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
