            ...
            <div class="row">
                <div class="col-md stretch-card grid-margin">
                    <div class="text-white card bg-gradient-danger card-img-holder">
                        <div class="card-body">
                            <img src="{{ URL::asset ('frontend/assets/images/dashboard/circle.svg') }}" class="card-img-absolute" alt="circle-image" />
                            <h5 class="mb-4 font-weight-normal">Weekly Sales <i class="float-right mdi mdi-chart-line mdi-24px"></i>
                            </h5>
                            <h4 class="mb-3">This Week : Rp. {{ number_format($dataprice['totalPriceThisWeek'], 0, ',', '.') }}</h4>
                            <h4 class="mb-3">Last Week : Rp. {{ number_format($dataprice['totalPriceLastWeek'], 0, ',', '.') }}</h4>
                ...
                {{-- <div class="col-md-4 stretch-card grid-margin">
                    <div class="text-white card bg-gradient-success card-img-holder">
                        <div class="card-body">
                            <img src="{{ URL::asset ('frontend/assets/images/dashboard/circle.svg') }}" class="card-img-absolute" alt="circle-image" />
                            <h4 class="mb-3 font-weight-normal">Visitors Online <i class="float-right mdi mdi-diamond mdi-24px"></i>
                            </h4>
