                                ...
                                <table class="table" id="myTable">
                                    <thead>
                                        <tr class="" style="background-color: #f1f1f6">
                                            <th style="font-size: 14px; width: 30px" class="py-2 my-2 sticky"> MR </th>
                                            ...
                                            <th style="font-size: 14px; width: 40px" class="py-2 my-2"> Stat </th>
                                    ...
                                    <tbody id="pricelistTableBody">
                                        ...
                                        @foreach ($materialrequests as $user)
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <td data-href="{{ route('material.show', $user->id) }}" style="padding-top: 3px; padding-bottom:3px;" class="sticky">
                                                        00{{ $user->id }}</td>
                                                        
                                                    <td data-href="{{ route('material.show', $user->id) }}" style="padding-top: 3px; padding-bottom:3px;" class="">
                                                        {{ $user->idpo }}</td>
                                                    ...
                                                    <td data-href="{{ route('material.show', $user->id) }}" style="padding-top: 3px; padding-bottom:3px;" class="ellipsis">
                                                        {{ $firstItem }}</td>
                                                    <td data-href="{{ route('material.show', $user->id) }}" style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    ...
                                                    <td  style="padding-top: 3px; padding-bottom:3px;" class="d-flex ">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="{{ route('material.show', $user->id) }}">Detail</a></li>
