                                    ...
                                    <tbody>
                                        @foreach ($purchasing as $user)
                                            ...
                                            <tr @if ($user->status == "Waiting") class="fw-bold bg-hover" @elseif ($user->status == "Declined") class="text-danger bg-hover" @else class="bg-hover"  @endif >
                                                ...
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ $firstItem }}</td>
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ \Carbon\Carbon::parse($user->created_at)->format('j M y') }}</td>
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ $user->mrnumber }}</td>
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ \Carbon\Carbon::parse( $user->mrtanggal)->format('j M y') }}</td>
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ \Carbon\Carbon::parse($firstEtauser)->format('j M y') }}</td>
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ $firstqty }}</td>
                                                <td data-href="{{ route('purchaseorder.show', $user->id) }}" style="font-size: 14px; padding-top: 3px; padding-bottom:3px;">{{ $user->supplier }}</td>
