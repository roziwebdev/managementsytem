                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('withdrawdept.store') }}"
                                id="pricelistForm">
                                @csrf
                                <div class="row stretch-card grid-margin shadow" style="background-color: #f1f1f6">
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="date" class="form-control form-control-sm " name="tanggalwithdraw" required>
                                        </div>
                                    </div>
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                            ...
                            <table class="table" id="materialRequestTable">
                                <thead>
                                    <tr class="" style="background-color: #f1f1f6">
                                        ...
                                        <th style="font-size: 14px" class="py-2 my-2"> DATE WD </th>
                                        <th style="font-size: 14px" class="py-2 my-2"> STS </th>
                                        ...
                                        <tr>
                                            <div class="table-responsive">
                                                ...
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    {{ $data->dept }}</td>
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    {{ \Carbon\Carbon::parse($data->tanggalwithdraw)->format('j M y') }}</td>
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="text-center">
                                                    @if ($data->status === 'waiting')
                                                    <div class="d-flex gap-3 align-items-center">
                                                        <a class="" href="{{ route('withdrawdept.updateStatus', ['id' => $data->id]) }}">
                                                ...
                                                <td class="text-center" style="padding-top: 3px; padding-bottom:3px;">
                                                    <div class="d-flex gap-3 align-items-center">
                                                        <a class="btn btn-sm btn-gradient-info" href="{{route('withdrawdept.edit', $data->id)}}">
                                                            <span class="material-symbols-outlined"  style="font-size:15px">
                                                                edit
                                                            </span>
                                                        </a>
                                                        <form action="{{ route('withdrawdept.destroy', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-sm btn-gradient-danger" type="submit">
                                                                <span class="material-symbols-outlined"  style="font-size:15px">
                                                                    delete
                                                                </span>
                                                            </button>
