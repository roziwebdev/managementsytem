                    ...
                    <div class="card rounded-xl shadow">
                        <div class="card-body shadow border">
                            ...
                            <div class="d-flex  py-3">
                                <div class="dropdown">
                                    <a class="btn px-5 btn-dark dropdown-toggle" href="#" role="button"
                                ...
                                <table class="table" id="myTable">
                                    <thead>
                                        <tr class="" style="background-color: #f1f1f6">
                                            <th style="font-size: 14px; width: 40px" class="py-2 my-2 sticky"> PO </th>
                                            ...
                                            <th style="font-size: 14px; " class="py-2 my-2"> Stat </th>
                                    ...
                                    <tbody>
                                        @foreach ($purchasing as $user)
                                            ...
                                            >
                                                <td  data-href="{{ route('listpo.show', $user->id) }}"  class="sticky bg-hover">{{ $user->id }}</td>
                                                <td  data-href="{{ route('listpo.show', $user->id) }}"  style="font-size: 14px; padding-top: 2px; padding-bottom:2px;">{{ $firstItem }}</td>
                                                <td  data-href="{{ route('listpo.show', $user->id) }}"  style="font-size: 14px; padding-top: 2px; padding-bottom:2px;">{{ $firstqty }} {{ $firstunit }}</td>
                                                <td  data-href="{{ route('listpo.show', $user->id) }}"  style="font-size: 14px; padding-top: 2px; padding-bottom:2px;">{{ $user->supplier }}</td>
                                                <td  data-href="{{ route('listpo.show', $user->id) }}"  style="font-size: 14px; width: 40px; padding-top: 3px; padding-bottom:3px;">
                                                      @if ($user->status == 'Process')
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" data-bs-toggle="modal"
                                                                        data-bs-target="#editStatusModal{{ $user->id }}">Approve</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('listpo.show', $user->id) }}">Detail</a></li>
