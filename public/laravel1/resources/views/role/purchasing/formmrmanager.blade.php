...
<body>
    <div class="container-xxl">
        ...
        <!-- Modal untuk mengedit status -->
                                                ...
                                                <!--    <a class="btn btn-danger" href="/manager/material">Back</a>-->
                                                <!--    <button class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#editStatusModal{{ $materialrequest->id }}">Approve</button>-->
                                                <!--</div>-->
...
<strong>Send To &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> {{$materialrequest->alamat}}
         ...
         <div class="py-2 d-flex">
                                                    <a class="btn btn-primary btn-sm" href="/manager/material">
