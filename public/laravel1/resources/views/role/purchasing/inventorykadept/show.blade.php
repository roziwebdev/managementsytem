                        ...
                        <div class="pb-5 ">
                            ...
                            <div class="card- shadow border">
                                ...
                                <div class="d-flex justify-content-center">
                                     <form method="GET" action="/inventorykadept/{{ $item->id }}">
                                <div class='row '>
                            ...
                            <table class="table" id="materialRequestTable">
                                <thead>
                                    <tr class="" style="background-color: #f1f1f6">
                                        ...
                                        <th style="font-size: 14px" class="py-2 my-2"> DATE ARV </th>
                                        <th style="font-size: 14px" class="py-2 my-2"> DATE CR </th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr>
                                            <div class="table-responsive">
                                                ...
                                                <td style="padding-top: 4px; padding-bottom:4px;" class="">
                                                    {{ $data->remarks }}</td>
                                                <td style="padding-top: 4px; padding-bottom:4px;" class="">
                                                    {{ \Carbon\Carbon::parse($data->tanggalbeli)->format('j M y') }}</td>
                                                <td style="padding-top: 4px; padding-bottom:4px;" class="">
