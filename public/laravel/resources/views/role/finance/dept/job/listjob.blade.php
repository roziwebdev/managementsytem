...
function exportToExcel() {
    ...
    for (let i = 0; i < rows.length; i++) {
        ...
        for (let j = 0; j < cols.length; j++) {
            ...
            // Kolom dengan indeks 1, 2, 3, 4, 10, 11, 13, 33 dianggap sebagai format tanggal
            if ([0, 1, 2, 3, 9, 10, 11, 13, 17, 33].includes(j)) {
            ...
            // Kolom dengan indeks 27 dan 29 dianggap sebagai format angka
            else if ([27, 29].includes(j)) {
    ...
    const formattedTime = currentDate.toLocaleTimeString().replace(/:/g, ':'); // Format: HH-MM-SS

    const fileName = `DatabaseJOB_${formattedDate}_${formattedTime}.xlsx`;
                            ...
                            <table class="table" id="materialRequestTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top:4px; padding-bottom:4px;">{{
                                            \Carbon\Carbon::parse($data->tanggalterima)->format('j M y')}}</td>
                                        <td style="padding-top:4px; padding-bottom:4px;">{{
