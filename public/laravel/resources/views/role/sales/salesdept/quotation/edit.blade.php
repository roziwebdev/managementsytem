                ...
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('quotation.update', $quotation->id) }}"
                            ...
                            $finalqtynegos = json_decode($quotation->qtyfinalnego);
                            $finalpricenegos = json_decode($quotation->pricefinalnego);
                            $combinedData = array_map(null, $products, $materials, $sizes, $specs, $qtys, $units, $prices, $statusitem, $noteitem, $finalqtys, $finalprices,$finalqtynegos,$finalpricenegos);
                            @endphp
                            ...
                            <div id='row2'>
                                ...
                                <div class="shadow row" style="background-color: #f1f1f6">
                                    <div class="mt-3 col-md ">
                                         <div class="mb-3" style="font-size: 14px">
                                             <label for="" class="form-label fw-bold">Final Quantity</label>
                                             <input class="form-control form-control-sm rounded-3 shadow-sm" name="qtyfinalnego[]" value="{{ $data[9] }}" />
                                         </div>
                                     </div>
                                    <div class="mt-3 col-md ">
                                         <div class="mb-3" style="font-size: 14px">
                                             <label for="" class="form-label fw-bold">Final Price</label>
                                             <input class="form-control form-control-sm rounded-3 shadow-sm" name="pricefinalnego[]" value="{{ $data[10] }}" />
                                         </div>
                                     </div>
                                </div>
                                <div class="shadow row" style="background-color: #f1f1f6">
                                    <div class="mt-3 col-md ">
                                         <div class="mb-3" style="font-size: 14px">
                                             <label for="" class="form-label fw-bold">Qty PO</label>
                                             <input class="form-control form-control-sm rounded-3 shadow-sm" name="finalqty[]" value="{{ $data[11] }}" />
                                         </div>
                                     </div>
                                    <div class="mt-3 col-md ">
                                         <div class="mb-3" style="font-size: 14px">
                                             <label for="" class="form-label fw-bold">Price PO</label>
                                             <input class="form-control form-control-sm rounded-3 shadow-sm" name="finalprice[]" value="{{ $data[12] }}" />
                                         </div>
                                     </div>
                                </div>
                                <div class="shadow  row" style="background-color: #f1f1f6">
