                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table" id="materialRequestTable">
                                ...
                                <tbody>
                                    @foreach ($job as $data)
                                    <tr>
                                        <td style="font-size: 14px; width:20px; padding-top:6px; padding-bottom:6px;"
                                            scope="col" class="sticky">{{ $data->id}}</td>
                                        <td style="padding-top:6px; padding-bottom:6px;">{{ $data->nosc}}</td>
                                        ...
                                        <td style="padding-top:6px; padding-bottom:6px;">{{ $data->product}}</td>
                                        <td style="padding-top:6px; padding-bottom:6px;">{{ $data->po}}</td>
                                        <td style="padding-top:6px; padding-bottom:6px;">{{ \Carbon\Carbon::parse($data->tanggalterima)->format('j M y')}}</td>
                                        <td style="padding-top:6px; padding-bottom:6px;">{{ \Carbon\Carbon::parse($data->created_at)->format('j M y')}}</td>
                                        <td style="padding-top:6px; padding-bottom:6px;">{{ \Carbon\Carbon::parse($data->updated_at)->format('j M y')}}</td>
