...
<body>
    <div class="container-xxl">
        <div class='d-flex justify-content-between'>
            <div>
                <br />
                <h2 style=''>{{ $quotation->customer }}</h2>
                <p>Malang</p>
        ...
        <p>Demikian penawaran harga dari kami supaya menjadi periksa adanya. Besar Harapan kami untuk segera mendapat
            kabar dari Bapak/ibu. Atas perhatian dan kerjasama yang baik kami ucapakan terima kasih.</p>
        <div>
            <p class="align-items-center">Hormat kami,</p>
            <div style="position: relative;">
                <img style="width: 120px;  " src="{{ URL::asset('frontend1/img/photos/signaturenologo.png') }}" />
            </div>
            <p>
                <b>
            ...
            <p>
                ...
                <br />
                - Harga tidak mengikat, sewaktu-waktu dapat berubah, sebelum PO dibuka mohon dikonfarmisak terlebih
                dahulu secara lisan/tulis kepada kami
                <br />
                - Toleransi pengiriman barang -+ 10% dari jumlah pesanan
                <br />
                - New Customer DP 50% dari total PO
            </p>
        </div>
    </div>
</body>
