                        ...
                        <form class="form-sample" method="POST" action="{{route('kadeptdocketnew.update', $design->id)}}">
                            ...
                            <div class="row px-5" style="background-color: #f1f1f6">
                                <div class="col">
                                    ...
                                    @if($design->a == "A")
                                      <input class="form-check-input" type="checkbox" checked id="A" value="A" name="a">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="A" value="A" name="a">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->b == "B")
                                      <input class="form-check-input" type="checkbox" checked id="B" value="B" name="b">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="B" value="B" name="b">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->c == "C")
                                      <input class="form-check-input" type="checkbox" checked id="C" value="C" name="c">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="C" value="C" name="c">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->d == "D")
                                      <input class="form-check-input" type="checkbox" checked id="D" value="D" name="d">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="D" value="D" name="d">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->e == "E")
                                      <input class="form-check-input" type="checkbox" checked id="E" value="E" name="e">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="E" value="E" name="e">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->f == "F")
                                      <input class="form-check-input" type="checkbox" checked id="F" value="F" name="f">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="F" value="F" name="f">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->g == "G")
                                      <input class="form-check-input" type="checkbox" checked id="G" value="G" name="g">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="G" value="G" name="g">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                     @if($design->h == "H")
                                      <input class="form-check-input" type="checkbox" checked id="H" value="H" name="h">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="H" value="H" name="h">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->i == "I")
                                      <input class="form-check-input" type="checkbox" checked id="I" value="I" name="i">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="I" value="I" name="i">
                                    @endif
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                    @if($design->j == "J")
                                      <input class="form-check-input" type="checkbox" checked id="J" value="J" name="j">
                                    @else
                                      <input class="form-check-input" type="checkbox" id="J" value="J" name="j">
                                    @endif
