            ...
            <div class="col-12 stretch-card grid-margin" id="">
                <div class="border rounded card">
                    <div class="border rounded shadow card-body">
                        ...
                        <form class="form-sample" method="POST" action="{{ route('updateShowSc', ['id' => $sc->id, 'index' => $index]) }}">
                            @csrf
                            @method('PUT')
                        @csrf
                            <div class="row" style="background-color: #f1f1f6">
                                        ...
                                        <input type="text" class="form-control form-control-sm clickable" name="designno" id="inputdesign"
                                            ...
                                            <datalist id="designno">
                                                @foreach ($designno as $design)
                                                    <option value="{{ $design->designno }}"></option>
                                                @endforeach
                                ...
                                <div class="mt-3 col-md">
                                    <div class="mb-3" style="font-size: 14px">
                                        ...
                                        <input type="text" class="form-control form-control-sm clickable" name="" id="getStatusorder"
                                            placeholder="" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="background-color: #f1f1f6">
                                ...
                                <input type="hidden" class="form-control form-control-sm clickable" name="statusjob" value="Approve">
                            ...
                            <div>
                                <button type="submit" class="pt-2 mt-2 btn-rounded btn btn-gradient-info float-end">
                                    Submit
                                </button>
                            </div>
                            </form>
                                            ...
                                            <div class="row px-4">
                                                <div class="col-lg">
                                                    ...
                                                    <p style="font-size:14px" class="mb-1"><span style="font-weight: 600">PO Date
                                                        ...
                                                        \Carbon\Carbon::parse($sc->tanggalpo)->format('j M y')}}</p>
