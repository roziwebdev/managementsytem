...
<body>
    ...
    <div class="container-xxl">
        ...
        <div class="py-2 d-flex">
            <a class="btn btn-primary btn-sm" href="/manager/purchase">
        ...
        <div class="text-center d-flex justify-content-around">
            <div>
               ...
               <br>
                ...
                <div style="position: relative;">
                    <img style="width: 90px;  " src="{{ URL::asset('frontend1/img/photos/signaturenologo.png') }}" />
                    <img style="width: 110px; position: absolute; top: -10px; left: 10px; z-index: -1; opacity: 0.3;"
                        src="{{ URL::asset('frontend1/img/photos/logoarjaya.png') }}" />
                </div>
                ...
                <div style="position: relative;">
                    <img style="width: 95px;  " src="{{ URL::asset('frontend1/img/photos/signceo.png') }}" />
                    <img style="width: 110px; position: absolute; top: -10px; left: 10px; z-index: -1; opacity: 0.3;"
                        src="{{ URL::asset('frontend1/img/photos/logoarjaya.png') }}" />
                </div>
