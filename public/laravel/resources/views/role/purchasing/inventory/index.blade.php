                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            <h4 class="card-title mb-3">Form Inventory Item</h4>
                                        ...
                                        <tr>
                                            <div class="table-responsive">
                                                ...
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                 ...
                                                 <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    <a class="btn btn-sm btn-gradient-info" href="{{ route('inventory.show', $data->id) }}">Detail</a>
                                                </td>
                                            </div>
                                        </tr>
                                    @endforeach
