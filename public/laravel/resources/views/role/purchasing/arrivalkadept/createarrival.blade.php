                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('arrivalpokadept.store') }}" enctype="multipart/form-data" id="pricelistForm">
                                @csrf
                                   ...
                                   @if($arrival->po == $materialrequest->id)
                                        <tr>
                                         ...
                                         <td style="padding-top: 3px; padding-bottom:3px;">{{ $arrival->arrivalqty }} {{$arrival->unit}}</td>
                                            ...
                                            <td><a href='{{route("arrivalpokadept.edit",$arrival->id)}}' class='btn btn-info btn-sm'>Open</a></td>
