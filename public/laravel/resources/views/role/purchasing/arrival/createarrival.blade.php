...
<link rel="stylesheet"
                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            ...
                            <form class="form-sample" method="POST" action="{{ route('arrivalpurchasing.store') }}" enctype="multipart/form-data" id="pricelistForm">
                                @csrf
                                <div class="row stretch-card grid-margin shadow" style="background-color: #f1f1f6">
                                    ...
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="file" class="form-control form-control-md" name="sjimage" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row  shadow" style="background-color: #f1f1f6">
                                    ...
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="text" class="form-control form-control-sm " name="arrivalqty" id="input2" required oninput="updateInput()"required >
                                        </div>
                                    </div>      
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                    ...
                                    <div class="col-md mt-3">
                                        <div class="mb-3" style="font-size: 14px">
                                            ...
                                            <input type="date" class="form-control form-control-sm " name="tanggalbeli" id="arrivalDate" required>
                                        </div>
                                      <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Mengatur nilai awal input tanggal ke hari ini
        arrivalDateInput.value = today;

        // Menambahkan event listener untuk memeriksa tanggal segera setelah memilih
        arrivalDateInput.addEventListener('input', function() {
            var selectedDate = new Date(arrivalDateInput.value);
            var currentDate = new Date();

            if (selectedDate > currentDate) {
                // Menampilkan alert jika tanggal lebih dari hari ini
                alert('Tanggal kedatangan tidak dapat lebih dari hari ini.');
                // Mengatur nilai input kembali ke hari ini
                arrivalDateInput.value = today;
            }
        });
    });
                                    ...
                                    @if($arrival->po == $materialrequest->id)
                                        <tr>
                                         ...
                                         <td style="padding-top: 3px; padding-bottom:3px;"> {{ $arrival->arrivalqty }} {{$arrival->unit}}</td>
                                            ...
                                            <td><button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#editStatusModal{{ $arrival->id }}">Open</td>
