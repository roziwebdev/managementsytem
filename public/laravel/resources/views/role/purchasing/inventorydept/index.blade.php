                ...
                <div class="col-12 stretch-card grid-margin">
                    <div class="card border rounded">
                        <div class="card-body shadow  border rounded">
                            <h4 class="card-title mb-3">Form Add Items</h4>
                            <form class="form-sample" method="POST" action="{{ route('inventorydept.store') }}"
                                id="pricelistForm">
                                @csrf
                                    ...
                                    <tr class="" style="background-color: #f1f1f6">
                                        ...
                                        <li>
                                             <form action="" method="GET"
                                                ...
                                                <input type="hidden" name="type" value="{{ request('sort_by') }}">
                                                <input type="hidden" name="dept" value="{{ request('dept') }}">
                                        ...
                                        <tr>
                                            <div class="table-responsive">
                                                ...
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="{{ $data->qty == 0 ? 'text-danger font-weight-bold' : ($data->qty <= $data->safetystock ? 'text-warning font-weight-bold' : 'font-weight-bold') }}">
                                                 ...
                                                 <td style="padding-top: 3px; padding-bottom:3px;" class="">{{ $data->dept }}</td>
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="">{{ \Carbon\Carbon::parse($data->updated_at)->format('j M y') }}</td>
                                                <td style="padding-top: 3px; padding-bottom:3px;" class="">{{ \Carbon\Carbon::parse($data->created_at)->format('j M y') }}</td>
                                                 <td style="padding-top: 3px; padding-bottom:3px;" class="">
                                                    <a class="btn btn-sm btn-gradient-info" href="{{ route('inventorydept.show', $data->id) }}">Detail</a>
                                                </td>
                                            </div>
                                        </tr>
                                    @endforeach
