...
class PurchaseorderdeptController extends Controller
{
    public function index(Request $request)
{
    ...
    return view('role.purchasing.podept.listpodept', compact('purchasing', 'sort', 'status'));
}
    ...
    public function show($id)
    {
        ...
        return view('role.purchasing.podept.detailpodept', ['materialrequest' => $materialrequest]);
    }
