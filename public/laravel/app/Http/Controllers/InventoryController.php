...
class InventoryController extends Controller
{
    ...
    $itemlist = Inventorylist::latest()->paginate(15);
        return view('role.purchasing.inventory.index', compact('items','itemlist','sort','iteminven'));
    }                   
    ...
    public function indexitem()
    {
        ...
        $itemlist = Inventorylist::latest()->paginate(15);
        return view('role.purchasing.inventory.indexitem', compact('items','itemlist'));
    }
...
$inventorywd = Inventorywithdraw::where('item', $item->item)->where('status', 'approve');
    ...
    return view('role.purchasing.inventory.show', compact('item', 'inventorylist', 'inventorywd', 'totalQtyIn','totalQtyOut', 'diff'));
}
