...
class InventorykadeptController extends Controller
{
    ...
    $itemlist = Inventorylist::latest()->paginate(15);
        return view('role.purchasing.inventorykadept.index', compact('items','itemlist','iteminven'));
    }
    public function indexitem()
    {
        $items = Inventory::latest()->paginate(15);
        $itemlist = Inventorylist::latest()->paginate(15);
        return view('role.purchasing.inventorykadept.indexitem', compact('items','itemlist'));
    }
   ...
   public function store(Request $request)
    {
        ...
        return redirect()->route('inventorykadept.index');
    }
 ...
 public function show($id, Request $request)
{
    ...
    return view('role.purchasing.inventorykadept.show', compact('item', 'inventorylist', 'inventorywd', 'totalQtyIn','totalQtyOut', 'diff'));
}
