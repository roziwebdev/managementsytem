...
class InventorykadeptwithdrawController extends Controller
{
    ...
    public function index()
{
    ...
    return view('role.purchasing.inventorykadept.withdraw', compact('withdraws','items'));
}
  ...
  public function store(Request $request)
{
    ...
    return redirect()->route('inventorykadept.index')->with('success', 'Pengambilan berhasil disimpan.');
}
