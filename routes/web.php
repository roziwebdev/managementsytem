...
use App\Http\Controllers\Prodev\ManagerProdev\DesignManagerController;
use App\Http\Controllers\Prodev\ManagerProdev\DocketnewManagerController;
...
use App\Http\Controllers\Prodev\AllKadeptProdev\JoballkadetpController;
use App\Http\Controllers\Prodev\AllDeptProdev\JoballdeptController;
...
use App\Http\Controllers\Finance\Kadept\FinanceJobnonppnKadeptController;
...
use App\Http\Controllers\Nonppn\sales\dept\SalesnonppnController;
use App\Http\Controllers\Nonppn\prodev\kadept\ProdevnonppnKadeptController;

use App\Http\Controllers\Nonppn\prodev\manager\ProdevnonppnManagerController;
use App\Http\Controllers\Nonppn\sales\manager\SalesnonppnManagerController;

use App\Http\Controllers\Nonppn\prodev\alldeptprodev\JobnonppnalldeptController;
use App\Http\Controllers\Nonppn\prodev\allkadeptprodev\JobnonppnallkadeptController;

use App\Http\Controllers\Prodev\KadeptProdev\CustomerprodevKadeptController;
use App\Http\Controllers\Prodev\KadeptProdev\PlantprodevKadeptController;

use App\Http\Controllers\Prodev\KadeptProdev\ProdevtrialKadeptController;
use App\Http\Controllers\Prodev\AllDeptProdev\JobtrialalldeptController;
use App\Http\Controllers\Prodev\AllKadeptProdev\JobtrialallkadeptController;

use App\Http\Controllers\Sales\AllKadeptSales\SalesallkadeptController;
use App\Http\Controllers\Sales\AllDeptSales\SalesalldeptController;

use App\Http\Controllers\Prodev\Purchasing\JobPurchasingController;
use App\Http\Controllers\Prodev\AllDeptProdev\PackagingalldeptController;
use App\Http\Controllers\Prodev\AllKadeptProdev\PackagingallkadeptController;

use App\Http\Controllers\Hrd\Dept\LembursatpamController;
use App\Http\Controllers\Hrd\Dept\SatpamController;
use App\Http\Controllers\Hrd\Kadept\LembursatpamkadeptController;
use App\Http\Controllers\Hrd\Kadept\SatpamkadeptController;
...
*/
    ...
    Route::get('/get-karyawansatpam/{kodekar}', [LembursatpamController::class, 'getdatakaryawansatpam']);
    ...
    Route::get('/check-datasales', [SalesController::class, 'checkData']);
...
Route::middleware(['auth', 'roles:purchasing'])->group(function () {
    Route::resource('purchasingjob', JobPurchasingController::class);
...
Route::middleware(['auth', 'roles:kadept'])->group(function () {
    Route::resource('satpamkadept', SatpamkadeptController::class);
    Route::resource('lembursatpamkadept', LembursatpamkadeptController::class);
    Route::resource('packagingallkadept', PackagingallkadeptController::class);
    Route::resource('salesallkadept', SalesallkadeptController::class);
    Route::resource('jobtrialallkadept', JobtrialallkadeptController::class);
    Route::resource('/jobapprove', JoballkadetpController::class);
    Route::post('/arrivalpokadept/{id}', [ArrivalkadeptController::class, 'update']);
    Route::resource('/jobapprovenonppn', JobnonppnallkadeptController::class);
...
Route::middleware(['auth', 'roles:dept'])->group(function () {
    ...
    Route::resource('lembursatpam', LembursatpamController::class);

    Route::resource('packagingalldept', PackagingalldeptController::class);
    Route::resource('salesalldept', SalesalldeptController::class);
    Route::resource('jobtrialalldept', JobtrialalldeptController::class);
    Route::resource('jobdeptapprove', JoballdeptController::class);
    Route::resource('jobdeptapprovenonppn', JobnonppnalldeptController::class);
    Route::get('/approvesplnonstaff', [LemburController::class, 'indexapprove']);
    Route::get('/revisisplnonstaff', [LemburController::class, 'indexrevisi']);
    Route::get('/declinedsplnonstaff', [LemburController::class, 'indexdeclined']);
    Route::get('/approvesplnonstaff', [LemburController::class, 'indexapprove']);
...
Route::middleware(['auth', 'roles:manager'])->group(function () {
    ...
    Route::resource('/manager/docketold', DesignManagerController::class);
    Route::resource('/manager/docketnew', DocketnewManagerController::class);
    ...
    Route::put('/managernonppn/update-statusscnonppn/{id}', [SalesnonppnManagerController::class, 'updateStatus'])->name('update_statusscnonppn');
    Route::get('/managernonppn/printscnonppn/{id}', [SalesnonppnManagerController::class, 'print'])->name('managernonppn.print');
    Route::put('/update-statusmanager-jobnonppn/{id}', [ProdevnonppnManagerController::class, 'updateStatusJobManager'])->name('updateStatusJobManagernonppn');
    Route::resource('/managernonppn/salesnonppn', SalesnonppnManagerController::class);
    Route::resource('/managernonppn/prodevnonppn', ProdevnonppnManagerController::class);
});
...
Route::middleware(['auth', 'roles:dept', 'departement:sales'])->group(function () {
    ...
    Route::resource('salesnonppndept', SalesnonppnController::class);
    Route::get('/quotationsc/{id}', [QuotationController::class, 'quotationsc'])->name('quotationsc');
    ...
    Route::get('/printscnonppn/{id}', [SalesnonppnController::class, 'print'])->name('salesnonppndept.print');
...
Route::middleware(['auth', 'roles:kadept', 'departement:Prodev'])->group(function () {
    ...
    Route::resource('customerprodevkadept',CustomerprodevKadeptController::class);
    Route::resource('plantprodevkadept',PlantprodevKadeptController::class);
    ...
    Route::get('/download-tablejobkadept', [ProdevKadeptController::class, 'downloadTable'])->name('downloadTableKadept');
    
    Route::resource('kadeptprodevnonppn/kadeptjobnonppn', ProdevnonppnKadeptController::class);
    Route::get('/kadeptprodevnonppn/create/{id}/{index}', [ProdevnonppnKadeptController::class, 'createshowsc'])->name('kadeptjobnonppn.createshowsc');
    Route::put('/kadeptprodevnonppn/create/{id}/{index}', [ProdevnonppnKadeptController::class, 'updateShowSc'])->name('kadeptsalesjobnonppn.update');
    Route::get('/kadeptprodevnonppn/kadeptlistjobnonppn', [ProdevnonppnKadeptController::class, 'jobindex'])->name("kadeptjobnonppn.jobindex");
    Route::get('/kadeptprodevnonppn/scjobnonppn', [ProdevnonppnKadeptController::class, 'indexscjobnonppn']);
    Route::put('/update-reqedit-jobnonppn/{id}', [ProdevnonppnKadeptController::class, 'reqEditJob'])->name('reqEditJobnonppn');
    Route::put('/update-status-jobnonppn/{id}', [ProdevnonppnKadeptController::class, 'updateStatusJob'])->name('updateStatusJobnonppn');
    Route::get('/download-tablejobkadeptnonppn', [ProdevnonppnKadeptController::class, 'downloadTable'])->name('downloadTableKadeptnonppn');
    
    Route::resource('kadeptprodevtrial/kadeptjobtrial', ProdevtrialKadeptController::class);
    Route::put('/update-reqedit-jobtrial/{id}', [ProdevtrialKadeptController::class, 'reqEditJobtrial'])->name('reqEditJobtrial');
    Route::put('/update-status-jobtrial/{id}', [ProdevtrialKadeptController::class, 'updateStatusJobtrial'])->name('updateStatusJobtrial');
    Route::get('/kadeptprodevtrial/create/{id}/{index}', [ProdevtrialKadeptController::class, 'createshowsctrial'])->name('kadeptjobtrial.createshowsc');
    Route::put('/kadeptprodevtrial/create/{id}/{index}', [ProdevtrialKadeptController::class, 'updateShowSctrial'])->name('kadeptsalesjobtrial.update');
    
});
    Route::get('/kadeptprintjobtrial/{id}', [ProdevtrialKadeptController::class, 'print'])->name('kadeptjobtrial.print');
    Route::get('/kadeptprintjob/{id}', [ProdevKadeptController::class, 'print'])->name('kadeptjob.print');
    Route::get('/kadeptprintjobnonppn/{id}', [ProdevnonppnKadeptController::class, 'print'])->name('kadeptjobnonppn.print');
...
Route::middleware(['auth','roles:kadept','departement:FA & TAX'])->group(function(){
    ...
    Route::resource('financekadept/jobnonppn',FinanceJobnonppnKadeptController::class);
    Route::get('/download-tablekadept',[FinanceJobKadeptController::class,'downloadTable'])->name('downloadTableFinance');
});
