...
class InventoryuserController extends Controller
{
    ...
    $itemlist = Inventorylist::latest()->paginate(15);
        return view('role.purchasing.inventoryuser.index', compact('items','itemlist'));
    }
    public function indexitem()
    {
        $items = Inventory::latest()->paginate(15);
        $itemlist = Inventorylist::latest()->paginate(15);
        return view('role.purchasing.inventoryuser.indexitem', compact('items','itemlist'));
    }
   ...
   public function store(Request $request)
    {
        ...
        return redirect()->route('inventoryuser.index');
    }
 ...
 public function show($id, Request $request)
{
    ...
    return view('role.purchasing.inventoryuser.show', compact('item', 'inventorylist', 'inventorywd', 'totalQtyIn','totalQtyOut', 'diff'));
}
