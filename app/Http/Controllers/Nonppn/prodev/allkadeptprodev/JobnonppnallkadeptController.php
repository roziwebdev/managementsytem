...
namespace App\Http\Controllers\Nonppn\prodev\allkadeptprodev;

use App\Http\Controllers\Controller;
use App\Models\Prodevnonppn;
use Illuminate\Http\Request;

class JobnonppnallkadeptController extends Controller
{
      public function index(Request $request) 
    {
        ...
        return view('role.nonppn.prodev.prodevallkadept.job.listjob', compact('job'));
    }
}
