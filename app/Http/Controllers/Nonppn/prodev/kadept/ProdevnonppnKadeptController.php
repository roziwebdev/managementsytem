...
namespace App\Http\Controllers\Nonppn\prodev\kadept;
...
class ProdevnonppnKadeptController extends Controller
{
    public function index1(){
        $sc = Salesnonppn::all();
        $job = Prodevnonppn::all();
        return view('role.nonppn.prodev.prodevkadept.job.listprodev',compact('job','sc'));
    }
...
public function index(Request $request) {
    ...
    return view('role.nonppn.prodev.prodevkadept.job.listprodev', compact('sc'));
}
public function indexscjob(Request $request) {
    ...
    return view('role.nonppn.prodev.prodevkadept.job.listprodevsc', compact('sc'));
}
    ...
    return view('role.nonppn.prodev.prodevkadept.job.listjob', compact('job'));
}
   ...
   public function createshowsc($id, $index) {
    ...
    return view('role.nonppn.prodev.prodevkadept.job.createjob', compact('boxes','sc', 'selectedItem','designno','index','docketnew'));
}
...
public function updateShowsc(Request $request, $id, $index) {
   ...
   return redirect()->route('kadeptjobnonppn.index');
}
...
public function update(Request $request, $id){
    ...
    if (!$job) {
        return redirect()->route('kadeptjobnonppn.index')->with('error', 'Record not found');
    }
...
public function store(Request $request)
{
    ...
    public function show($id){
        ...
        return view('role.nonppn.prodev.prodevkadept.job.show', compact('details'));
}
    ...
    public function getdatadesign($designno, $id){
    ...
    public function edit($id){
        ...
        $job = Prodevnonppn::find($id);
        $boxes = Box::all();
        return view('role.nonppn.prodev.prodevkadept.job.edit',compact('boxes','job'));
    }

    public function print($id){
        $job = Prodevnonppn::find($id);
        return view('role.nonppn.prodev.prodevkadept.job.print', compact('job'));
    }
