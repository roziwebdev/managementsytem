...
class ArrivalController extends Controller
{
   ...
   $sortBy = $request->input('sort_by', null);
    ...
    $arrivals = $query->latest('created_at')->paginate($perPage);
        return view('role.purchasing.arrivaldept.listarrival',compact('arrivals'));
    }
     ...
     public function show(Request $request,$id)
        {
            ...
            return view('role.purchasing.arrivaldept.createarrival', compact('materialrequest','arrivals'));
        }
}