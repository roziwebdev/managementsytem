...
class InventoryuserwithdrawController extends Controller
{
    ...
    public function index()
{
    ...
    return view('role.purchasing.inventoryuser.withdraw', compact('withdraws','items'));
}
  ...
  public function store(Request $request)
{
    ...
    return redirect()->route('inventoryuser.index')->with('success', 'Pengambilan berhasil disimpan.');
}
