...
class ProductsalesController extends Controller
{
    ...
    $productsales = $query->orderBy('id', 'desc')->paginate(20);
    ...
    public function store(Request $request)
    {
        ...
        $productsales->toleransi = $request->toleransi;
        $productsales->save();
    ...
    public function edit( $id)
    {
        ...
        return view('role.sales.salesdept.productsales.editproductsales', compact('productsales'));
