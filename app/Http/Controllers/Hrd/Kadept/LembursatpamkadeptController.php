...
class LembursatpamkadeptController extends Controller
{
    ...
    // Terapkan paginasi jika tidak ada filter
        ...
        return view('role.hrd.lembursatpam.lemburkadept.listlembursatpam', compact('lemburs', 'satpam','status'));
    }
    ...
    public function store (Request $request){
        ...
        $lembursatpam->save();
        return redirect()->route('lembursatpamkadept.index');
    }

    public function edit($id){
        $lembur = Lembursatpam::find($id); 
        return view('role.hrd.lembursatpam.lemburkadept.editlembursatpam', compact('lembur'));
    }
        ...
        public function getdatakaryawan($kodekar)
    {
        ...
        if ($satpam) {
            return response()->json(['jabatan' => $satpam->jabatan, 'departement' => $satpam->outsourcing]);
        } else {
