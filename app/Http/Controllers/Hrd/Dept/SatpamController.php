...
class SatpamController extends Controller
{
    ...
    // Pencarian berdasarkan ID atau produk
        ...
        return view('role.hrd.karyawansatpam.karyawansatpamdept.listsatpam', compact('satpams'));
    }
    ...
    public function edit($id){
        ...
        return view('role.hrd.karyawansatpam.karyawansatpamdept.editsatpam', compact('satpam'));
    }
