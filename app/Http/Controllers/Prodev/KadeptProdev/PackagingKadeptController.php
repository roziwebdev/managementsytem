...
class PackagingKadeptController extends Controller
{
    public function index(Request $request)
    {
        ...
        $packagings = $query->orderBy('id', 'desc')->paginate(10);


        return view('role.prodev.prodevkadept.packaging.listpackaging', compact('packagings','boxes'));
    }
    ...
    public function edit( $id)
    {
        ...
        return view('role.prodev.prodevkadept.packaging.editpackaging', compact('packaging','boxes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $packaging->save();
       return redirect()->route('kadeptpackaging.index');
    }
